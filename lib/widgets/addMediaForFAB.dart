...
class AddMediaFor extends StatefulWidget {
  final String email;
  bool rememberMe;
  AddMediaFor({this.email,this.rememberMe});
  @override
  _AddMediaForState createState() => _AddMediaForState();
}

class _AddMediaForState extends State<AddMediaFor> {
  @override
