...
class EventImageCapture extends StatefulWidget {
  final String email,event;
  EventImageCapture(this.email,this.event);
  @override
  _EventImageCaptureState createState() => _EventImageCaptureState();
}

class _EventImageCaptureState extends State<EventImageCapture> {
  File _imageFile;
