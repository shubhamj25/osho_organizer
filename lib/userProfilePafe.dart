...
import 'package:oshoorganiser/profileImg.dart';
import 'package:oshoorganiser/walletHomescreen.dart';
                ...
                return snapshot.hasData?ListView(
                  children: [
                    Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          subtitle: Center(child: Text("Osho Organizer",style:GoogleFonts.balooBhaina(
                            fontSize: 18.0,
                          ),
                          )),
                        ),
                    ...
                    DataTable(columns: <DataColumn>[
                      ...
                      DataColumn(
                          label: Text("Owner Details", style: TextStyle(color: Colors.black)))
                    ], rows: <DataRow>[
                      DataRow(
                        cells: <DataCell>[
                          DataCell(Text(
                      ...
                      DataRow(
                        cells: <DataCell>[
                          ...
                          DataCell(
                            TextFormField(
                              initialValue: "${snapshot.data['ashram']??"Enter Ashram Name"}",
                              style: TextStyle(fontWeight: FontWeight.w300, color: Colors.blue),
                              decoration: InputDecoration(
                                focusedBorder: InputBorder.none,
                                disabledBorder: InputBorder.none,
