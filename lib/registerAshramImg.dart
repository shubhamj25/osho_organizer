...
class AshramImageCapture extends StatefulWidget {
  final String email;
  AshramImageCapture(this.email);
  @override
  _AshramImageCaptureState createState() => _AshramImageCaptureState();
}

class _AshramImageCaptureState extends State<AshramImageCapture> {
  File _imageFile;
...
class Uploader extends StatefulWidget {
  ...
  Uploader({Key key,this.file, this.email, this.event}) : super(key:key);
  @override
...
class _UploaderState extends State<Uploader> {
  ...
  Future<void> startUpload() async {
    String filePath = 'ashrams/${DateTime.now()}.png';
    setState(() {
